...
import { sharesocialCod, clockLinkCod, calculatorLinkCod, sortingVisualizerLinkCod, beginnerPythonCod, ecommerceCod, moviesCod, connetCod, rushCod, cpsCod, bikeCod } from '../../Links/GitHubLinks';
import { sharesocialWeb, ecommerceWeb, moviesWeb, connetWeb, rushWeb, cpsWeb } from '../../Links/WebsiteLinks';
import { JavascriptLogo, ReactLogo, MUILogo, BikeRepairBanner, CommercejsLogo, StripeLogo, CssLogo, BootstrapLogo, MERNLogo, ExpressLogo, MongoDBLogo, AxiosLogo, PythonLogo, DjangoLogo, VSCODELogo, PycharmLogo, SanityLogo, GoogleAuthLibLogo, socialMediaBanner, TailwindLogo, ReactRDLogo, ReactIconLogo } from '../../Links/ImgLinks';
